<fieldset>
	...
	<?php echo $this->Form->create('Parametro', array('class' => 'form-horizontal',
		...
		echo $this->Form->input('modulo',array('label'=>array('class'=>'control-label col-sm-2')));
		echo $this->Form->input('variable',array('label'=>array('class'=>'control-label col-sm-2')));
		echo $this->Form->input('valor',array('label'=>array('class'=>'control-label col-sm-2')));
	?>
